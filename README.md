...
Soon, I decided to rewrite it in Rust. Major disadvantage of 7Bee was using XML that made all scipts too bulky.
So one of the goals of the  **Rust Bee** was getting rid of XML, reducing the scripts footprint and making them easy readable.
